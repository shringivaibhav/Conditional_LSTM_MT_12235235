...
# Defining the valid range of Follobanen project (excluding first 1000m and last 500m, testing length, reversed as excavation is on the other side)
valid_range = (Follo_df[chainage_column] >= min_chainage + 500) & (Follo_df[chainage_column] < max_chainage - 1000)
...
# Saving to a new Parquet file
df_interp.to_parquet("Follo_Finalv2.parquet", engine = "pyarrow", index=False)
df_interp = pd.read_parquet("Follo_Finalv2.parquet", engine = "pyarrow")
